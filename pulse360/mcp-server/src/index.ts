...
server.registerTool(
  ...
  {
    description:
      "Writes a self-improvement plan as a CSV file to the user's downloads or a specified path. " +
...
server.registerTool(
  ...
  {
    description:
      "Saves an approved HTML performance report to disk as an .html file. The user can open it " +
