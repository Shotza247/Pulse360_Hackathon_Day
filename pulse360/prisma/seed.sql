...
-- Workforce and demographic simulation for MVP 2 analytics dashboards.
-- Keeps the demo realistic: 13 of 57 non-system employees are non-permanent,
-- junior roles trend toward learnership/internship, and selected senior
-- consulting roles are contract based.
UPDATE employee e
SET
